package com.josiel.projetomc.services.validation.utils;
...
public class BR {
	...
	private static final int[] weightSsn = { 11, 10, 9, 8, 7, 6, 5, 4, 3, 2 }; // CNPJ
